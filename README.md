...
| Android Gradle Plugin | 8.13.0 | catalog `agp` |
| Kotlin | 2.1.21 | catalog `kotlin` |
| KSP | 2.1.21-2.0.2 | catalog `ksp` |
...
4. Let the initial Gradle sync finish. It downloads the Gradle 8.13
...
| --- | --- | --- |
| Gradle build and version catalog | **Done** | AGP 8.13.0, Kotlin 2.1.21, JVM 17, configuration cache on. |
